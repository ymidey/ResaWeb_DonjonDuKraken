    ...
    <div class="evenement-header">
        <?php foreach ($resultEvenement as $row) { ?>
            ...
            <div class="evenement-text">
                ...
                <p><?php echo $row['Nb_Place'] ?> places disponibles</p>
                ...
                <form action="" method="get">
                    <label for="add-participant">Ajouter des participants </label>
                    <input type="number" name="add-participant" id="add-participant">
