                ...
                <div class="filter-participant filter">
                    <label for="participant">
                        ...
                        <input type="number" id="participant" name="participant-evenement"
                            placeholder="Un nombre est attendu"
            ...
            <div class="dropdown">
                <label for="tri">
                    ...
                    <div class="options">
                        ...
                        <div><a
                                href="nos-evenements.php?<?php echo http_build_query(array_merge($current_params, array('tri' => 'date décroissante'))); ?>">Par
                        ...
                        <div><a
                                href="nos-evenements.php?<?php echo http_build_query(array_merge($current_params, array('tri' => 'prix décroissant'))); ?>">Par
                                prix décroissant</a></div>
                        <div><a
                                href="nos-evenements.php?<?php echo http_build_query(array_merge($current_params, array('tri' => 'nouveauté'))); ?>">Par
