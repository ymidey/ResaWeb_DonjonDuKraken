...
<div class="nos-evenements">
    <div class="filter-div">
        <form class="filter-form" action="">
            ...
            <div class="filter-participant filter">
                <label for="participant">
                    ...
                    <input type="number" id="participant" name="participant-evenement" placeholder="Nombre attendu" value="<?php echo isset($_GET['participant-evenement']) ? $_GET['participant-evenement'] : '' ?>" />
                </label>
            </div>
        ...
        <button type="submit"><a href="nos-evenements.php">Réinitialiser tout les filtres</a></button>
    </div>
    <div class="liste-evenements">
        ...
        <div class="card-evenement">
            <?php if (empty($resultEvenements)) {
                echo "<p>Malheuresement, aucun événement a été trouvé, essayez de changer vos filtres ou de rééssayer plus tard.</p>";
            }
                ...
                <div class="card-container">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-content_otherinfo">
                            ...
                            <div class="card-link">
                                <a href="detail-evenement.php?ID_Evenement=<?php echo $row['ID_Evenement'] ?>" class="link-detail">Voir
                                    en détails</a>
                            </div>
                        </div>
                    </div>
