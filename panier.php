...
<main>
    ...
    ?>
    <div class="panier">
        <h1 class="title-panier"><span>Récapitulatif de la commande</span><span>Votre panier
        ...
        <div class="panier-content">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-number">
                            ...
                            <select name="add-participant[<?php echo $index; ?>]"
                                id="add-participant[<?php echo $index; ?>]" class="td-number add-participant">
                        ...
                        <td>
                            <a class="form-delete-produit"
                                href=" delete-produit-panier.php?index-produit=<?php echo $index; ?>"
                                onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce produit du panier ?');">
                                <button type="button"><img src="./Images/trash.svg" alt="Supprimer l'événement"
                                        title="Supprimer l'événement <?php echo $evenement['nomEvenement']; ?>"></button>
                            </a>
                        </td>
                    </tr>
            ...
            <div class="reservinfo modal-invisible">
                ...
                <form action="ajout-reservation.php" class="form-reservation" method="post">
                    ...
                    <label for="nom">Votre nom* <span>(Maximum 255 caractère)</span></label>
                    <input type="text" maxlength="255" name=" nom" id="nom" required>
                    <label for="prenom">Votre prénom* <span>(Maximum 255 caractère)</span></label>
                    <input type="text" maxlength="255" name=" prenom" id="prenom" required>
                    <label for="email">Votre adresse email* <span>(Maximum 255 caractère)</span></label>
                    <input type="email" maxlength="255" name=" email" id="email" required>
        ...
        <a href="delete-produit-panier.php" class="btn-delete-panier"
            onclick="return confirm('Êtes-vous sûr de vouloir supprimer tous les événements de votre panier ?');">
